...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { name: @family.name, organization_id: @family.organization_id } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { name: @family.name, organization_id: @family.organization_id } }
